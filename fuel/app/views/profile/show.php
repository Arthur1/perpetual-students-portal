...
<div class="collection">
	...
	<?= Html::anchor('result/article/'.$record['game_id'], date('Y/m/d H:i', $record['game_id']).' '.$record['player_num'].'人 '.$record['regulation'].'<br>'.$record['player_order'].'番手 '.$record['total_score'].'点 '.$record['rank'].'位', ['class' => 'collection-item']); ?>
	<?php endforeach; ?>
</div>